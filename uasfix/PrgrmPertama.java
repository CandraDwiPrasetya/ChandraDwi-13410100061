import java.util.* ;
public class PrgrmPertama {
  public static Vector <UserProgram> username = new Vector <UserProgram>() ;
  public static Scanner sc=new Scanner (System.in) ;
  
  public static void main (String [] argc) {
    //Data Pertama
    username.add(new UserProgram("candra","123","admin")) ;
    username.add(new UserProgram("candra","123","kasir")) ;
    int pil=0 ;
    do {
      System.out.println("===========================");
      System.out.println("  Toko Buah Candra");
      System.out.println("==========================");
