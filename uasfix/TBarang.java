...
public class TBarang {
    ...
    public static barang stokAwal=new barang("01","semangka",12000);
    public static barang stokAwal1=new barang("02","apel",22000);
    public static barang stokAwal2=new barang("03","mangga",30000);
    public static barang stokAwal3=new barang("04","pisang",20000);
    public static barang stokAwal4=new barang("05","jambu",40000);
    ...
    public static void addBarang(){
      if (start==false){
          ...
          tabelbarang.add(stokAwal2);
          tabelbarang.add(stokAwal3);
          tabelbarang.add(stokAwal4);
      }
          boolean input=false;
          start=true;
          do{
  ...
  public static String bacaStr(String pesan){ 
   ...
   public static int caribuah(String nambuah){
    int idx=-1;
    int i=0;
    do{
  ...
  return idx;
   ...
   {
     String cari = DbBarang.bacaStr("Masukan Nama Buah yang dicari: ");
 ...
 for (int i=0;i<jml;i++){ 
   ...
   String namaBuah;
   do{
           namaBuah=DbBarang.bacaStr("Masukan Nama Buah : ");
          indexnama=DbBarang.caribuah(namaBuah);
          if (indexnama==-1){
          ...
          if (indexnama!=-1){
            ...
            barang b1=new barang(id,namaBuah, hargabeli);
